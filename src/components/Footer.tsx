      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="bg-burgundy w-6 h-6 rounded-md flex items-center justify-center">
                <span className="text-white font-bold text-sm">E</span>
              </div>
              <span className="font-bold text-xl">Terra Legacy</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/mortgage" className="text-gray-400 hover:text-white">Mortgage Calculator</Link></li>
              <li><Link href="/valuation" className="text-gray-400 hover:text-white">Free Valuation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-gray-400">info@Terra Legacy.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© {new Date().getFullYear()} Terra Legacy. All rights reserved.</p>
